...
SEARCH_URLS = [
    f"https://www.gsmarena.com/results.php3?nPriceMin={min}&nPriceMax={max}&nDisplayResMin=2073600&chkReview=selected&sAvailabilities=1"
    for min, max in [(900, None), (700, 900), (600, 700), (450, 600), (350, 450), 
